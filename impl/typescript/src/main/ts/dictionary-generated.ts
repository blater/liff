...
import { makeEntry, makeReference, type Entry } from "./model";

export const TITLE = "The Meaning of Liff";
export const AUTHOR = "Douglas Adams";

export const ENTRIES: readonly Entry[] = Object.freeze([
    makeEntry(
        "AASLEAGH",
        "n.",
    ...
    makeEntry(
        ...
        [
            makeReference("ARDSCALPSIE", "q.v.", "ardscalpsie"),
        ],
    ),
    makeEntry(
        "ARDSLIGNISH",
    ...
    makeEntry(
        ...
        [
            makeReference("ARAGLIN", "q.v.", "araglin"),
        ],
    ),
    makeEntry(
        "BARSTIBLEY",
    ...
    makeEntry(
        ...
        [
            makeReference("CLONMULT", "q.v.", "clonmult"),
            makeReference("SADBERGE", "q.v.", "sadberge"),
        ],
    ),
    makeEntry(
        "BURBAGE",
    ...
    makeEntry(
        ...
        [
            makeReference("YATE", "q.v.", "yates"),
            makeReference("THROCKMORTON", "q.v.", "throckmorton"),
            makeReference("THROCKING", "q.v.", "throcking"),
        ],
    ),
    makeEntry(
        "BURSLEDON",
    ...
    makeEntry(
        ...
        [
            makeReference("KIRBY", "q.v.", "kirbies"),
        ],
    ),
    makeEntry(
        "CLABBY",
        ...
        [
            makeReference("CLIXBY", "q.v.", "clixby"),
            makeReference("DITHERINGTON", "q.v.", "ditherington"),
        ],
    ),
    makeEntry(
        "CLACKAVOID",
    ...
    makeEntry(
        ...
        [
            makeReference("BULDOO", "q.v.", "buldoo"),
            makeReference("SADBERGE", "q.v.", "sadberge"),
        ],
    ),
    makeEntry(
    ...
    makeEntry(
        ...
        [
            makeReference("CORRIEVORRIE", "q.v.", "corrievorrie"),
        ],
    ),
    makeEntry(
        "CORRIEDOO",
    ...
    makeEntry(
        ...
        [
            makeReference("CORRIEDOO", "q.v.", "corriedoo"),
            makeReference("CORRIECRAVIE", "q.v.", "corriecravie"),
            makeReference("CORRIEVORRIE", "q.v.", "corrievorrie"),
        ],
    ),
    makeEntry(
    ...
    makeEntry(
        ...
        [
            makeReference("CLABBY", "q.v.", "clabby"),
        ],
    ),
    makeEntry(
        "DITTISHAM",
    ...
    makeEntry(
        ...
        [
            makeReference("WEST WITTERING", "q.v.", "west wittering"),
        ],
    ),
    makeEntry(
        "EDGBASTON",
    ...
    makeEntry(
        ...
        [
            makeReference("EPPING", "q.v.", "epping"),
        ],
    ),
    makeEntry(
        "ERIBOLL",
    ...
    makeEntry(
        ...
        [
            makeReference("SWANAGE", "q.v.", "swanage"),
        ],
    ),
    makeEntry(
        "GLUTT LODGE",
    ...
    makeEntry(
        ...
        [
            makeReference("ELY", "q.v.", "ely"),
            makeReference("WEMBLEY", "q.v.", "wembley"),
        ],
    ),
    makeEntry(
        "GOLANT",
    ...
    makeEntry(
        ...
        [
            makeReference("GOOSNARGH", "q.v.", "Goosnargh"),
        ],
    ),
    makeEntry(
        "HOBBS CROSS",
    ...
    makeEntry(
        ...
        [
            makeReference("CHIPPING ONGAR", "see_also", "CHIPPING ONGAR"),
        ],
    ),
    makeEntry(
        "KIRBY MISPERTON",
    ...
    makeEntry(
        ...
        [
            makeReference("MAVIS ENDERBY", "q.v.", "mavis enderby"),
        ],
    ),
    makeEntry(
        "MAARUIG",
    ...
    makeEntry(
        ...
        [
            makeReference("SIDCUP", "q.v.", "sidcups"),
        ],
    ),
    makeEntry(
        "MONKS TOFT",
    ...
    makeEntry(
        ...
        [
            makeReference("SKEGNESS", "q.v.", "skegness"),
        ],
    ),
    makeEntry(
        "PELUTHO",
    ...
    makeEntry(
        ...
        [
            makeReference("WIMBLEDON", "q.v.", "wimbledon"),
            makeReference("BOTLEY", "q.v.", "botley"),
        ],
    ),
    makeEntry(
        "PIMLICO",
    ...
    makeEntry(
        ...
        [
            makeReference("AGGLETHORPE", "q.v.", "agglethorpe"),
        ],
    ),
    makeEntry(
        "QUENBY",
    ...
    makeEntry(
        ...
        [
            makeReference("PEEBLES", "q.v.", "peeble"),
            makeReference("BELPER", "q.v.", "belper"),
        ],
    ),
    makeEntry(
        "SADBERGE",
    ...
    makeEntry(
        ...
        [
            makeReference("BODMIN", "q.v.", "bodmin"),
        ],
    ),
    makeEntry(
        "SCRAPTOFT",
    ...
    makeEntry(
        ...
        [
            makeReference("SNITTER", "q.v.", "snitters"),
            makeReference("SNITTERFIELD", "q.v.", "snitterfields"),
            makeReference("VIRGINSTOW", "q.v.", "virginstows"),
        ],
    ),
    makeEntry(
        "SNITTERFIELD",
        ...
        [
            makeReference("SNITTER", "q.v.", "snitters"),
            makeReference("SNITTERBY", "q.v.", "snitterbies"),
        ],
    ),
    makeEntry(
        "SOLENT",
    ...
    makeEntry(
        ...
        [
            makeReference("GLOSSOP", "q.v.", "glossop"),
        ],
    ),
    makeEntry(
        "SWANIBOST",
    ...
    makeEntry(
        ...
        [
            makeReference("SPROSTON GREEN", "q.v.", "sproston green"),
        ],
    ),
    makeEntry(
        "TWOMILEBORRIS",
    ...
    makeEntry(
        ...
        [
            makeReference("DORCHESTER", "q.v.", "dorchester"),
        ],
    ),
    makeEntry(
        "UPOTTERY",
    ...
    makeEntry(
        ...
        [
            makeReference("ARAGLIN", "q.v.", "araglins"),
        ],
    ),
    makeEntry(
        "WATH",
